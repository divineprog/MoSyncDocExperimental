...
["blog/2013/01/how-extend-javascript-custom-c-code-opening-google-maps-hybrid-app","js/tutorials/ui/extend-javascript-with-custom-cpp-code",[JS,CPP,TUTORIAL,WEBUI]],
...
["documentation/manualpages/javascripthtml5-cross-platform-user-interfaces-0","cpp/guides/ui/javascripthtml5-cross-platform-user-interfaces",[CPP,JS,GUIDE,NATIVEUI,WEBUI,MAUI]],
